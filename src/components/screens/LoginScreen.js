...
const LoginScreen = ({setIsJoined, setData, user}) => {
  ...
  const onSubmit = (event) => {
    ...
    setData({user: refNick.current.nick.value, url: refNick.current.url.value})
  }
  return (
    <div className="login-container">
      <div className="login-items">
        <div id="title">CinemAres</div>
        <CSSTransition in={!user} nodeRef={nodeRef1} timeout={500} unmountOnExit onExited={() => setIsJoined(true)} classNames="fade">
          <div ref={nodeRef1}>
